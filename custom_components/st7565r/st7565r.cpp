...
namespace esphome
{
  namespace st7565r
  {
    ...
    float ST7565r::get_setup_priority() const { return setup_priority::HARDWARE; }
    ...
    void ST7565r::invert(bool invert)
    {
      this->command_(invert ? 0xA7 : 0xA6 /* invert on/off */);
    }
    ...
    void ST7565r::set_contrast(uint8_t val) // 0..63
    {
    ...
    void ST7565r::set_internal_resistor_ratio(uint8_t val) // 0..7
    {
      this->command_(ST7565r_RESISTOR_RATIO | (val & 0x07));
    }
  } // namespace st7565r
} // namespace esphome
